...
class SupportTestingMailFakeTest extends TestCase
{
    ...
    public function testAssertNotSentWithString()
    {
        ...
        $this->expectException(ExpectationFailedException::class);
        $this->expectExceptionMessageIsOrContains('The unexpected ['.MailableStub::class.'] mailable was sent to address [taylor@laravel.com].');
    ...
    public function testAssertNotSentWithArray()
    {
        ...
        $this->expectException(ExpectationFailedException::class);
        $this->expectExceptionMessageIsOrContains('The unexpected ['.MailableStub::class.'] mailable was sent to address [dries@laravel.com].');
    ...
    public function testAssertNotQueuedWithString()
    {
        ...
        $this->expectException(ExpectationFailedException::class);
        $this->expectExceptionMessageIsOrContains('The unexpected ['.MailableStub::class.'] mailable was queued to address [taylor@laravel.com].');
    ...
    public function testAssertNotQueuedWithArray()
    {
        ...
        $this->expectException(ExpectationFailedException::class);
        $this->expectExceptionMessageIsOrContains('The unexpected ['.MailableStub::class.'] mailable was queued to address [dries@laravel.com].');
