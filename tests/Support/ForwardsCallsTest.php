...
class ForwardsCallsTest extends TestCase
{
    ...
    public function testMissingForwardedCallThrowsCorrectError()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Call to undefined method Illuminate\Tests\Support\ForwardsCallsOne::missingMethod()');
    ...
    {
        $this->expectException(BadMethodCallException::class);
        $this->expectExceptionMessageIsOrContains('Call to undefined method Illuminate\Tests\Support\ForwardsCallsOne::this1_shouldWork_too()');
    ...
    public function testNonForwardedErrorIsNotTamperedWith()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Call to undefined method Illuminate\Tests\Support\ForwardsCallsBase::missingMethod()');
    ...
    {
        $this->expectException(BadMethodCallException::class);
        $this->expectExceptionMessageIsOrContains('Call to undefined method Illuminate\Tests\Support\ForwardsCallsOne::test()');
