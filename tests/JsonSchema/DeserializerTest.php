...
class DeserializerTest extends TestCase
{
    ...
    public function test_it_throws_for_an_unresolvable_ref(): void
    {
        ...
        $this->expectExceptionMessageIsOrContains('Unable to resolve JSON Schema $ref [#/$defs/Missing].');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Unable to resolve non-local JSON Schema $ref [https://example.com/user.json].');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Unable to determine the JSON Schema type for the given schema.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Circular JSON Schema $ref [#/$defs/node] detected.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Unsupported JSON Schema type [wat] in a multi-type union.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Unsupported JSON Schema type [123] in a multi-type union.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Type-specific keywords [items] are not supported on a multi-type JSON Schema union.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Unable to represent the schema for property [meta]; boolean schemas are not supported.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('The JSON Schema [minimum] constraint must be a number.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('The JSON Schema integer constraint [1.9] must be an integer.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Tuple and boolean JSON Schema "items" are not supported.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Conflicting [type] between a "anyOf" branch and its sibling keys.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Only a nullable "oneOf" (a single schema plus a "null" branch) is supported.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('A null JSON Schema [default] is not supported.');
    ...
    public function test_it_resolves_the_root_ref_pointer(): void
    {
        ...
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Circular JSON Schema $ref [#] detected.');
