...
class AuthAccessGateTest extends TestCase
{
    ...
    public function testAuthorizeThrowsUnauthorizedException()
    {
        ...
        $this->expectExceptionMessageIsOrContains('You are not an admin.');
    ...
    {
        $this->expectException(AuthorizationException::class);
        $this->expectExceptionMessageIsOrContains('Not allowed to view as it is not published.');
    ...
    {
        $this->expectException(AuthorizationException::class);
        $this->expectExceptionMessageIsOrContains('quz');
