...
class EnvironmentEncryptCommandTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->filesystem->allows('get')->returns(true)->allows('put')->returns('APP_NAME=Laravel');
    ...
    public function testItGeneratesTheCorrectFileWhenUsingEnvironment(): void
    {
        ...
        $this->filesystem->received('put')->with(base_path('.env.production.encrypted'), m::any());
    }

    public function testItGeneratesTheCorrectFileWhenNotUsingEnvironment(): void
    {
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(false)->expects('get');
        ...
        $this->filesystem->received('put')->with(base_path('.env.encrypted'), m::any());
    }
    ...
    {
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(true);
