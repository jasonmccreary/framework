...
class EnvironmentDecryptCommandTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->filesystem->allows('put')->returns(true);
        File::swap($this->filesystem);
    }

    public function testItFailsWithInvalidCipherFails(): void
    {
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(false);
    ...
    {
        $this->filesystem->allows('exists')->returns(true);
    ...
    {
        $this->filesystem->allows('exists')->returns(false);
    ...
    {
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(true)->expects('get')->returns((new Encrypter($key = Encrypter::generateKey('AES-256-CBC'), 'AES-256-CBC'))
    ...
    {
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(false)->expects('get')->returns((new Encrypter('abcdefghijklmnop', 'aes-128-gcm'))
    ...
    public function testItGeneratesTheEnvironmentFileWithKeyFromEnvironment(): void
    {
        ...
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(false)->expects('get')->returns((new Encrypter('ponmlkjihgfedcbaponmlkjihgfedcba', 'AES-256-CBC'))
    ...
    {
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(true)->expects('get')->returns((new Encrypter('abcdefghijklmnop', 'aes-128-gcm'))
                    ->encrypt('APP_NAME="Laravel Two"'));
    ...
    {
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(false)->expects('get')->returns((new Encrypter('abcdefghijklmnopabcdefghijklmnop', 'AES-256-CBC'))
                    ->encrypt('APP_NAME="Laravel Two"'));
    ...
    {
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(false)->expects('get')->returns((new Encrypter($key = 'abcdefghijklmnop', 'aes-128-gcm'))
                    ->encrypt('APP_NAME="Laravel Two"'));
    ...
    public function testItAutoDetectsAndDecryptsReadableFormat(): void
    {
        ...
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(false)->expects('get')->returns($encryptedContent);
    ...
    public function testItDecryptsBlobFormatWithNewlineInContent(): void
    {
        ...
        $this->filesystem->expects('exists')->returns(true)->expects('exists')->returns(false)->expects('get')->returns($encryptedContentWithNewline);
