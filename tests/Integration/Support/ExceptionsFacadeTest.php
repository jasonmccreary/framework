...
class ExceptionsFacadeTest extends TestCase
{
    ...
    {
        $this->expectException(ExpectationFailedException::class);
        $this->expectExceptionMessageIsOrContains('The expected [RuntimeException] exception was reported.');
    ...
    {
        $this->expectException(ExpectationFailedException::class);
        $this->expectExceptionMessageIsOrContains('The following exceptions were reported: RuntimeException, RuntimeException, InvalidArgumentException.');
    ...
    public function testThrowOnReportLeaveAppReportablesUntouched()
    {
        ...
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('My exception message');
