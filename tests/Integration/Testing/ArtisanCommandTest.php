...
class ArtisanCommandTest extends TestCase
{
    ...
    public function test_console_command_that_fails()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Expected status code 0 but received 1.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Output "Your name is Taylor Otwell and you prefer PHP." was printed.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Output "Taylor Otwell" was printed.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Output "0" was printed.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Output "Your name is Taylor Otwell and you prefer PHP." was not printed.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Expected status code 1 but received 0.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Output does not contain "Otwell Taylor".');
