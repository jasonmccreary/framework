...
class ContextIntegrationTest extends TestCase
{
    ...
    public function test_it_throws_on_incomplete_classes()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Value is incomplete class: {"__PHP_Incomplete_Class_Name":"App\\\\MyContextClass"}');
    ...
    public function test_it_throws_generic_unserialize_exceptions()
    {
        ...
        $this->expectExceptionMessageIsOrContains('unserialize(): Error at offset 0 of 8 bytes');
