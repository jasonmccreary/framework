...
class ThrottleRequestsTest extends TestCase
{
    ...
    public function testItFailsIfNamedLimiterDoesNotExist()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Rate limiter [test] is not defined.');
    ...
    {
        $this->expectException(MissingRateLimiterException::class);
        $this->expectExceptionMessageIsOrContains('Rate limiter ['.User::class.'::rateLimiting] is not defined.');
