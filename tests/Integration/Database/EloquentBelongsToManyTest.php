...
class EloquentBelongsToManyTest extends DatabaseTestCase
{
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessageIsOrContains('No query results for model [Illuminate\Tests\Integration\Database\EloquentBelongsToManyTest\Tag] 10');
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessageIsOrContains('No query results for model [Illuminate\Tests\Integration\Database\EloquentBelongsToManyTest\Tag] 10, 11');
