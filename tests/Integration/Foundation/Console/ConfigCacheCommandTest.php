...
class ConfigCacheCommandTest extends TestCase
{
    ...
    public function testConfigurationCacheFailsWithNonSerializableValue()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Your configuration files could not be serialized because the value at "testconfig.closure" is non-serializable.');
    ...
    public function testConfigurationCacheFailsWithNestedNonSerializableValue()
    {
        ...
        $this->expectException(LogicException::class);
        $this->expectExceptionMessageIsOrContains('Your configuration files could not be serialized because the value at "testconfig.nested.deep.closure" is non-serializable.');
