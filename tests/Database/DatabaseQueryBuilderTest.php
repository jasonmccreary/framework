...
class DatabaseQueryBuilderTest extends TestCase
{
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Non-numeric value passed as increment amount for column: \'col\'.');
        $builder = $this->getBuilder();
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Non-associative array passed to incrementEach method.');
        $builder = $this->getBuilder();
    ...
    public function testFirstOrFailMethodThrowsRecordNotFoundException()
    {
        ...
        $this->expectExceptionMessageIsOrContains('No record found for the given query.');
    ...
    {
        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessageIsOrContains('does not support');
        $builder = $this->getBuilder();
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('The unique columns must not be empty.');
        $builder = $this->getPostgresBuilder();
        $builder->from('users')->insertOrIgnoreReturning(['email' => 'foo'], ['*'], []);
    }
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('The returning columns must not be empty.');
        $builder = $this->getPostgresBuilder();
        $builder->from('users')->insertOrIgnoreReturning(['email' => 'foo'], []);
    }
...
SQL;
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Illegal operator and value combination.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('The number of columns must match the number of values');
