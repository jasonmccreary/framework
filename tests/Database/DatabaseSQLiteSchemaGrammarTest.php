...
class DatabaseSQLiteSchemaGrammarTest extends TestCase
{
    ...
    {
        $builder = TestDouble::for(SQLiteBuilder::class)->passthru()->allows('getColumns')->returns([
    ...
    {
        return TestDouble::for(SQLiteBuilder::class)->passthru()->allows('getColumns')->returns([])->allows('getIndexes')->returns([])
            ->shouldReceive('getForeignKeys')->andReturn([])
            ->getMock();
    }
}
