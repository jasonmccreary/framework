...
class DatabaseEloquentHasManyThroughIntegrationTest extends TestCase
{
    ...
    public function testFirstOrFailThrowsAnException()
    {
        ...
        $this->expectExceptionMessageIsOrContains('No query results for model [Illuminate\Tests\Database\HasManyThroughTestPost].');
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessageIsOrContains('No query results for model [Illuminate\Tests\Database\HasManyThroughTestPost] 1');
    ...
    {
        $this->expectException(ModelNotFoundException::class);
        $this->expectExceptionMessageIsOrContains('No query results for model [Illuminate\Tests\Database\HasManyThroughTestPost] 1, 2');
