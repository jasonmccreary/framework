...
class DatabaseEloquentBuilderTest extends TestCase
{
    ...
    {
        $builder = TestDouble::for(new Builder($this->getMockQueryBuilder()))->passthru();
        $model = $this->getMockModel();
        $builder->setModel($model);
        $model->expects('getKeyType')->returns('int');
        $builder->getQuery()->expects('where')->with('foo_table.foo', '=', 'bar');
        $builder->allows('first')->with(['column'])->returns('baz');
    ...
    public function testFindSoleMethod()
    {
        ...
        $model->expects('getKeyType')->returns('int');
        $builder->getQuery()->expects('where')->with('foo_table.foo', '=', 'bar');
        $builder->allows('sole')->with(['column'])->returns('baz');
    ...
    public function testFindManyMethod()
    {
        ...
        $builder->allows('get')->with(['column'])->returns(['baz']);
    ...
    public function testFindOrNewMethodModelNotFound()
    {
        $model = $this->getMockModel();
        $model->expects('getKeyType')->returns('int');
        $model->expects('findOrNew')->returns(TestDouble::for(Model::class));

        $builder = TestDouble::for(new Builder($this->getMockQueryBuilder()))->passthru();
        $builder->setModel($model);
        $builder->getQuery()->expects('where')->with('foo_table.foo', '=', 'bar');
        $builder->allows('first')->with(['column'])->returns(null);
    ...
    public function testFindOrFailMethodWithManyThrowsModelNotFoundException()
    {
        ...
        $model = $this->getMockModel();
        $model->allows('getKey')->returns(1);
        $model->allows('getKeyType')->returns('int');

        $builder = TestDouble::for(new Builder($this->getMockQueryBuilder()))->passthru();
        $builder->setModel($model);
        $builder->getQuery()->expects('whereIntegerInRaw')->with('foo_table.foo', [1, 2]);
        $builder->allows('get')->with(['column'])->returns(new Collection([$model]));
    ...
    public function testFindOrMethodWithMany()
    {
        ...
        $model1->allows('getKeyType')->returns('int');
    ...
    {
        $builder = TestDouble::for(new Builder($this->getMockQueryBuilder()))->passthru();
        $builder->allows('limit')->with(1)->returns($builder);
        $builder->allows('get')->with(['*'])->returns(new Collection(['bar']));
    ...
    {
        $builder = new Builder(TestDouble::for(BaseBuilder::class));
    ...
    {
        $builder = TestDouble::for(new Builder($this->getMockQueryBuilder()))->passthru();
        $builder->allows('applyScopes')->returns($builder);
        $builder->allows('getModels')->with(['foo'])->returns(['bar']);
        $builder->allows('eagerLoadRelations')->with(['bar'])->returns(['bar', 'baz']);
        $builder->setModel($this->getMockModel());
        $builder->getModel()->allows('newCollection')->with(['bar', 'baz'])->returns(new Collection(['bar', 'baz']));
    ...
    public function testGetMethodDoesntHydrateEagerRelationsWhenNoResultsAreReturned()
    {
        $builder = TestDouble::for(new Builder($this->getMockQueryBuilder()))->passthru();
        $builder->allows('applyScopes')->returns($builder);
        $builder->allows('getModels')->with(['foo'])->returns([]);
        $builder->expects('eagerLoadRelations')->never();
        $builder->setModel($this->getMockModel());
        $builder->getModel()->allows('newCollection')->with([])->returns(new Collection([]));
    ...
    public function testValueMethodWithModelFound()
    {
        ...
        $mockModel->name = 'foo';
        $builder->allows('first')->with(['name'])->returns($mockModel);
    ...
    {
        $builder = TestDouble::for(new Builder($this->getMockQueryBuilder()))->passthru();
        $builder->allows('first')->with(['name'])->returns(null);
    ...
    public function testChunkPaginatesUsingIdWithLastChunkComplete()
    {
        ...
        $chunk3 = new Collection([]);
        $builder->allows('getOffset')->returns(null);
        $builder->allows('getLimit')->returns(null);
    ...
    public function testLazyWithLastChunkComplete()
    {
        ...
        $builder->expects('forPage')->with(1, 2)->returns($builder);
        $builder->expects('forPage')->with(2, 2)->returns($builder);
        $builder->expects('forPage')->with(3, 2)->returns($builder);
    ...
    public function testPluckReturnsTheMutatedAttributesOfAModel()
    {
        ...
        $builder->getQuery()->allows('pluck')->with('name', '')->returns(new BaseCollection(['bar', 'baz']));
        $builder->setModel($this->getMockModel());
        $builder->getModel()->allows('hasAnyGetMutator')->with('name')->returns(true);
        $builder->getModel()->allows('newFromBuilder')->with(['name' => 'bar'])->returns(new EloquentBuilderTestPluckStub(['name' => 'bar']));
        $builder->getModel()->allows('newFromBuilder')->with(['name' => 'baz'])->returns(new EloquentBuilderTestPluckStub(['name' => 'baz']));
    ...
    public function testPluckReturnsTheCastedAttributesOfAModel()
    {
        ...
        $builder->getQuery()->allows('pluck')->with('name', '')->returns(new BaseCollection(['bar', 'baz']));
        $builder->setModel($this->getMockModel());
        $builder->getModel()->allows('hasAnyGetMutator')->with('name')->returns(false);
        $builder->getModel()->allows('hasCast')->with('name')->returns(true);
        $builder->getModel()->allows('newFromBuilder')->with(['name' => 'bar'])->returns(new EloquentBuilderTestPluckStub(['name' => 'bar']));
        $builder->getModel()->allows('newFromBuilder')->with(['name' => 'baz'])->returns(new EloquentBuilderTestPluckStub(['name' => 'baz']));
    ...
    {
        $builder = $this->getBuilder();
        $builder->getQuery()->allows('pluck')->with('created_at', '')->returns(new BaseCollection(['2010-01-01 00:00:00', '2011-01-01 00:00:00']));
        $builder->setModel($this->getMockModel());
        $builder->getModel()->allows('hasAnyGetMutator')->with('created_at')->returns(false);
        $builder->getModel()->allows('hasCast')->with('created_at')->returns(false);
        $builder->getModel()->allows('getDates')->returns(['created_at']);
        $builder->getModel()->allows('newFromBuilder')->with(['created_at' => '2010-01-01 00:00:00'])->returns(new EloquentBuilderTestPluckDatesStub(['created_at' => '2010-01-01 00:00:00']));
        $builder->getModel()->allows('newFromBuilder')->with(['created_at' => '2011-01-01 00:00:00'])->returns(new EloquentBuilderTestPluckDatesStub(['created_at' => '2011-01-01 00:00:00']));
    ...
    {
        $model = $this->getMockModel();
        $model->allows('qualifyColumn')->with('name')->returns('foo_table.name');

        $builder = $this->getBuilder();
        $builder->getQuery()->allows('pluck')->with($model->qualifyColumn('name'), '')->returns(new BaseCollection(['bar', 'baz']));
        $builder->setModel($model);
        $builder->getModel()->allows('hasAnyGetMutator')->with('name')->returns(true);
        $builder->getModel()->allows('newFromBuilder')->with(['name' => 'bar'])->returns(new EloquentBuilderTestPluckStub(['name' => 'bar']));
        $builder->getModel()->allows('newFromBuilder')->with(['name' => 'baz'])->returns(new EloquentBuilderTestPluckStub(['name' => 'baz']));
    ...
    {
        $model = $this->getMockModel();
        $model->allows('qualifyColumn')->with('created_at')->returns('foo_table.created_at');

        $builder = $this->getBuilder();
        $builder->getQuery()->allows('pluck')->with($model->qualifyColumn('created_at'), '')->returns(new BaseCollection(['2010-01-01 00:00:00', '2011-01-01 00:00:00']));
        $builder->setModel($model);
        $builder->getModel()->allows('hasAnyGetMutator')->with('created_at')->returns(false);
        $builder->getModel()->allows('hasCast')->with('created_at')->returns(false);
        $builder->getModel()->allows('getDates')->returns(['created_at']);
    ...
    public function testPluckWithoutModelGetterJustReturnsTheAttributesFoundInDatabase()
    {
        ...
        $builder->setModel($this->getMockModel());
        $builder->getModel()->allows('hasAnyGetMutator')->with('name')->returns(false);
        $builder->getModel()->allows('hasCast')->with('name')->returns(false);
        $builder->getModel()->allows('getDates')->returns(['created_at']);
    ...
    public function testGetModelsProperlyHydratesModels()
    {
        ...
        $model = TestDouble::for(Model::class.'[getTable,hydrate]');
    ...
    public function testEagerLoadRelationsLoadTopLevelRelationships()
    {
        ...
        $builder->shouldAllowMockingProtectedMethods()->allows('eagerLoadRelation')->with(['models'], 'foo', $nop1)->returns(['foo']);
    ...
    public function testRelationshipEagerLoadProcess()
    {
        ...
        $relation = TestDouble::for(stdClass::class);
    ...
    public function testRelationshipEagerLoadProcessForImplicitlyEmpty()
    {
        ...
        $builder = TestDouble::for(new Builder($queryBuilder))->passthru();
        ...
        $relation = TestDouble::for($model->parentFoo());
    ...
    public function testGetRelationProperlySetsNestedRelationships()
    {
        $builder = $this->getBuilder();
        $builder->setModel($this->getMockModel());
        $builder->getModel()->expects('newInstance->orders')->returns($relation = TestDouble::for(stdClass::class));
        $relationQuery = TestDouble::for(stdClass::class);
    ...
    public function testGetRelationProperlySetsNestedRelationshipsWithSimilarNames()
    {
        ...
        $builder->setModel($this->getMockModel());
        $builder->getModel()->expects('newInstance->orders')->returns($relation = TestDouble::for(stdClass::class));
        $builder->getModel()->expects('newInstance->ordersGroups')->returns($groupsRelation = TestDouble::for(stdClass::class));

        $relationQuery = TestDouble::for(stdClass::class);
        $relation->allows('getQuery')->returns($relationQuery);

        $groupRelationQuery = TestDouble::for(stdClass::class);
        $groupsRelation->allows('getQuery')->returns($groupRelationQuery);
    ...
    {
        $nestedQuery = TestDouble::for(Builder::class);
    ...
    {
        $model = $this->getMockModel();
        $model->allows('getCreatedAtColumn')->returns('foo');
        $builder = $this->getBuilder()->setModel($model);
    ...
    {
        $model = $this->getMockModel();
        $model->allows('getCreatedAtColumn')->returns(null);
        $builder = $this->getBuilder()->setModel($model);
    ...
    public function testUpdate()
    {
        ...
        $query = new BaseBuilder($connection, new Grammar($connection), TestDouble::for(Processor::class));
    ...
    public function testUpsert()
    {
        ...
        $query->allows('from')->with('foo_table')->returns('foo_table');
    ...
    {
        $query = TestDouble::for(BaseBuilder::class);
        $query->allows('from')->with('table')->returns('table');
        $query->from = 'table';
    ...
    {
        $query = TestDouble::for(BaseBuilder::class);
        $query->allows('toRawSql')->returns('select * from "users" where "email" = \'foo\'');
    ...
    {
        $builder = new class(TestDouble::for(BaseBuilder::class)) extends Builder
        {
    ...
    public function testIncrementEachCallsToBaseWithUpdatedAt()
    {
        ...
        $builder = new Builder($query);
        $model = $this->getMockModel();
        $model->allows('usesTimestamps')->returns(true);
        $model->allows('getUpdatedAtColumn')->returns('updated_at');
        $model->allows('freshTimestampString')->returns('2026-03-26 00:00:00');
        $model->allows('hasSetMutator')->returns(false);
        $model->allows('hasAttributeSetMutator')->returns(false);
        $model->allows('hasCast')->returns(false);
        $builder->setModel($model);
    ...
    public function testIncrementEachWithoutTimestamps()
    {
        ...
        $builder = new Builder($query);
        $model = $this->getMockModel();
        $model->allows('usesTimestamps')->returns(false);
        $builder->setModel($model);
