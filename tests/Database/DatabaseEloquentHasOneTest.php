...
class DatabaseEloquentHasOneTest extends TestCase
{
    ...
    public function testRelationCountQueryCanBeBuilt()
    {
        ...
        $builder->expects('select')->with(m::type(Expression::class))->returns($builder);
    ...
    protected function getRelation()
    {
        ...
        $this->builder->expects('whereNotNull')->with('table.foreign_key');
        $this->builder->expects('where')->with('table.foreign_key', '=', 1);
