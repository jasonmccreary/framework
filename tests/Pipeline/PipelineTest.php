...
class PipelineTest extends TestCase
{
    ...
    public function testPipelineThrowsExceptionOnResolveWithoutContainer()
    {
        ...
        $this->expectExceptionMessageIsOrContains('A container instance has not been passed to the Pipeline.');
    ...
    public function testPipelineFinallyWhenExceptionOccurs()
    {
        ...
        $this->expectExceptionMessageIsOrContains('My Exception: 1');
