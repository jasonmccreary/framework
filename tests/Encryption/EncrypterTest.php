...
class EncrypterTest extends TestCase
{
    ...
    public function testThatAnAeadTagMustBeProvidedInFullLength()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Could not decrypt the data.');
    ...
    public function testDoNoAllowLongerKey()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Unsupported cipher or incorrect key length. Supported ciphers are: aes-128-cbc, aes-256-cbc, aes-128-gcm, aes-256-gcm.');
    ...
    {
        $this->expectException(DecryptException::class);
        $this->expectExceptionMessageIsOrContains('The payload is invalid.');
    ...
    {
        $this->expectException(DecryptException::class);
        $this->expectExceptionMessageIsOrContains('Unable to use tag because the cipher algorithm does not support AEAD.');
    ...
    {
        $this->expectException(DecryptException::class);
        $this->expectExceptionMessageIsOrContains('The MAC is invalid.');
