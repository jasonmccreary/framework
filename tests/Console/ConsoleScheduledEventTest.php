...
class ConsoleScheduledEventTest extends TestCase
{
    ...
    public function testBasicCronCompilation()
    {
        ...
        $eventA = new Event(Double::for(EventMutex::class), 'php foo');
        $eventB = new Event(Double::for(EventMutex::class), 'php foo');
        $this->assertEquals(
    ...
    public function testTimeBetweenChecks()
    {
        ...
        $event = new Event(Double::for(EventMutex::class), 'php foo', 'UTC');
