...
class ImageTest extends TestCase
{
    ...
    public function test_dimensions_throws_when_dimensions_cannot_be_determined()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Unable to determine the dimensions of the image.');
    ...
    public function test_driver_exception_is_wrapped_in_image_exception()
    {
        ...
        $this->expectException(ImageException::class);
        $this->expectExceptionMessageIsOrContains('Failed to process image:');
    ...
    public function test_optimize_throws_for_jpg_with_wrong_spelling()
    {
        ...
        $this->expectException(ImageException::class);
        $this->expectExceptionMessageIsOrContains('The [jpge] format is not supported.');
    ...
    public function test_serialization_throws_exception()
    {
        ...
        $this->expectException(ImageException::class);
        $this->expectExceptionMessageIsOrContains('Images cannot be serialized. Store the image first and serialize the path instead.');
    ...
    {
        $this->expectException(ImageException::class);
        $this->expectExceptionMessageIsOrContains('At least one resize dimension must be specified.');
    ...
    {
        $this->expectException(ImageException::class);
        $this->expectExceptionMessageIsOrContains('At least one scale dimension must be specified.');
