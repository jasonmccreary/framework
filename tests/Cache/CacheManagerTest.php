...
class CacheManagerTest extends TestCase
{
    ...
    public function testThrowExceptionWhenUnknownDriverIsUsed()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Driver [unknown_taxi_driver] is not supported.');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Cache store [alien_store] is not defined.');
