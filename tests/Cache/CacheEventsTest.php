...
class CacheEventsTest extends TestCase
{
    ...
    {
        $dispatcher = $this->getDispatcher();
        $store = TestDouble::for(Store::class);
        $store->allows('forget')->returns(false);
        $repository = new Repository($store);
        $repository->setEventDispatcher($dispatcher);

        $dispatcher->expects('dispatch')->with($this->assertEventMatches(ForgettingKey::class, ['key' => 'baz']));
        $dispatcher->expects('dispatch')->with($this->assertEventMatches(KeyForgetFailed::class, ['key' => 'baz']));
    ...
    public function testFlushTriggersEvents()
    {
        ...
        $dispatcher->expects('dispatch')->with($this->assertEventMatches(CacheFlushing::class, [
                'storeName' => 'array',
            ]));

        $dispatcher->expects('dispatch')->with($this->assertEventMatches(CacheFlushed::class, [
                'storeName' => 'array',
            ]));
    ...
    public function testFlushLocksTriggersEvents()
    {
        ...
        $dispatcher->expects('dispatch')->with($this->assertEventMatches(CacheLocksFlushing::class, [
                'storeName' => 'array',
            ]));

        $dispatcher->expects('dispatch')->with($this->assertEventMatches(CacheLocksFlushed::class, [
                'storeName' => 'array',
            ]));
    ...
    public function testFlushFailureDoesDispatchEvent()
    {
        ...
        $failingStore = TestDouble::for(Store::class);
        $failingStore->allows('flush')->returns(false);
        ...
        $dispatcher->expects('dispatch')->with($this->assertEventMatches(CacheFlushFailed::class, [
                'storeName' => 'array',
            ]));
    ...
    public function testFlushLocksFailureDoesDispatchEvent()
    {
        ...
        $failingStore = TestDouble::for(ArrayStore::class);
        $failingStore->allows('flushLocks')->returns(false);
        ...
        $dispatcher->expects('dispatch')->with($this->assertEventMatches(CacheLocksFlushFailed::class, [
                'storeName' => 'array',
            ]));
