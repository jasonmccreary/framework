...
class ProcessTest extends TestCase
{
    ...
    public function testStrayProcessesCanBePreventedWithStringCommand()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Attempted process [');
        $this->expectExceptionMessageIsOrContains('cat composer.json');
        $this->expectExceptionMessageIsOrContains('] without a matching fake.');
    ...
    {
        $this->expectException(\RuntimeException::class);
        $this->expectExceptionMessageIsOrContains('fake exception message');
    ...
    {
        $this->expectException(ProcessFailedException::class);
        $this->expectExceptionMessageIsOrContains(<<<'EOT'
