...
class ViewFactoryTest extends TestCase
{
    ...
    public function testExceptionsInSectionsAreThrown()
    {
        ...
        $this->expectExceptionMessageIsOrContains('section exception message');
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Cannot end a section without first starting one.');
