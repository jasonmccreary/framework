...
class ValidationValidatorTest extends TestCase
{
    ...
    public function testCustomExceptionMustExtendValidationException()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Exception [RuntimeException] is invalid. It must extend [Illuminate\Validation\ValidationException].');
...
1',
    ...
    {
        $this->expectException(InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Validation rule required_if requires at least 2 parameters.');
