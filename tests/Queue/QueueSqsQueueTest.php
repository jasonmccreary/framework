...
class QueueSqsQueueTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->sqs = TestDouble::for(SqsClient::class);
    ...
    public function testBulkChunksAtTenMessagesPerBatch()
    {
        ...
        $this->sqs->shouldReceive('sendMessageBatch')->twice()->with(Argument::satisfies(function ($args) use (&$batchSizes) {
    ...
    public function testBulkSendsFifoBatchesSequentiallyUsingTheQueueNameForMessageGroups()
    {
        ...
        $this->sqs->shouldReceive('sendMessageBatch')->twice()->with(Argument::satisfies(function ($args) use (&$captured) {
            $captured[] = $args;
