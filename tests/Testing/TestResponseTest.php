...
class TestResponseTest extends TestCase
{
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Failed asserting that \'foo<strong>bar</strong>\' contains "bazfoo".');
...
EOT
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Failed asserting that \'foo<strong>bar</strong> baz <strong>foo</strong>\' contains "foobar" in specified order.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Failed asserting that \'foo<strong>bar</strong>baz<strong>qux</strong>\' does not contain "foobar".');
    ...
    public function testAssertOk(): void
    {
        ...
        $this->expectExceptionMessageIsOrContains('Expected response status code');
    ...
    public function testAssertMethodNotAllowed(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [405] but received 200.\nFailed asserting that 200 is identical to 405.");
    ...
    public function testAssertNotAcceptable(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [406] but received 200.\nFailed asserting that 200 is identical to 406.");
    ...
    public function testAssertBadRequest(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [400] but received 200.\nFailed asserting that 200 is identical to 400.");
    ...
    public function testAssertRequestTimeout(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [408] but received 200.\nFailed asserting that 200 is identical to 408.");
    ...
    public function testAssertPaymentRequired(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [402] but received 200.\nFailed asserting that 200 is identical to 402.");
    ...
    public function testAssertMovedPermanently(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [301] but received 200.\nFailed asserting that 200 is identical to 301.");
    ...
    public function testAssertFound(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [302] but received 200.\nFailed asserting that 200 is identical to 302.");
    ...
    public function testAssertNotModified(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [304] but received 200.\nFailed asserting that 200 is identical to 304.");
    ...
    public function testAssertTemporaryRedirect(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [307] but received 200.\nFailed asserting that 200 is identical to 307.");
    ...
    public function testAssertPermanentRedirect(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [308] but received 200.\nFailed asserting that 200 is identical to 308.");
    ...
    public function testAssertConflict(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [409] but received 200.\nFailed asserting that 200 is identical to 409.");
    ...
    public function testAssertGone(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [410] but received 200.\nFailed asserting that 200 is identical to 410.");
    ...
    public function testAssertTooManyRequests(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [429] but received 200.\nFailed asserting that 200 is identical to 429.");
    ...
    public function testAssertAccepted(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [202] but received 200.\nFailed asserting that 200 is identical to 202.");
    ...
    public function testAssertFailedDependency(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [424] but received 200.\nFailed asserting that 200 is identical to 424.");
    ...
    public function testAssertInternalServerError(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [500] but received 200.\nFailed asserting that 200 is identical to 500.");
    ...
    public function testAssertServiceUnavailable(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains("Expected response status code [503] but received 200.\nFailed asserting that 200 is identical to 503.");
    ...
    public function testAssertNoContentAssertsEmptyContent(): void
    {
        ...
        $this->expectExceptionMessageIsOrContains('Response content is not empty');
    ...
    public function testAssertHeaderMissing(): void
    {
        ...
        $this->expectExceptionMessageIsOrContains('Unexpected header [Location] is present on response.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Header [Precognition-Success] not present on response.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('The Precognition-Success header was found, but the value is not `true`.');
    ...
    public function testAssertJsonWithNull(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Invalid JSON was returned from the route.');
    ...
    public function testAssertJsonWithFluentHasAnyThrows(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('None of properties [data, errors, meta] exist.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Failed asserting that two strings are equal.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Failed asserting that 10 is identical to \'10\'.');
    ...
    public function testAssertJsonPathWithClosureCanFail(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Failed asserting that false is true.');
    ...
    public function testAssertJsonPathWithEnumCanFail(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Failed asserting that two strings are identical.');
    ...
    public function testAssertJsonPathCanonicalizingCanFail(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Failed asserting that two arrays are equal.');
    ...
    {
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Failed asserting that 10 is identical to 11.');
    ...
    public function testAssertHeaderContainsFailure(): void
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Header [X-Custom-Header] was found, but [unrelated] does not contain [value].');
    ...
    public function testItHandlesFalseJson(): void
    {
        ...
        $this->expectException(ExpectationFailedException::class);
        $this->expectExceptionMessageIsOrContains('Expected response status code [200] but received 422.');
