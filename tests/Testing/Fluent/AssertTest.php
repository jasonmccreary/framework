...
class AssertTest extends TestCase
{
    ...
    public function testAssertHasFailsWhenPropMissing()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Property [prop] does not exist.');
    ...
    public function testAssertHasFailsWhenNestedPropMissing()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [example.another] does not exist.');
    ...
    public function testAssertHasCountFailsWhenAmountOfItemsDoesNotMatch()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [bar] does not have the expected size.');
    ...
    public function testAssertHasCountFailsWhenPropMissing()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [baz] does not exist.');
    ...
    public function testAssertHasOnlyCountFails()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Root level does not have the expected size.');
    ...
    public function testAssertHasWithWhereNotFails()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [data.1.id] contains a value that should be missing: [id, 2]');
    ...
    public function testAssertHasWithWhereNotFailsClosure()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [data.1.id] was marked as invalid using a closure.');
    ...
    public function testAssertBetweenFails()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Root level size is not less than or equal to [2].');
    ...
    public function testAssertBetweenLowestValueFails()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Root level size is not greater than or equal to [4].');
    ...
    public function testAssertBetweenFailsScoped()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [bar] size is not less than or equal to [2].');
    ...
    public function testAssertMissingFailsWhenPropExists()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [foo.bar] was found while it was expected to be missing.');
    ...
    public function testAssertMissingAllFailsWhenAtLeastOnePropExists()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [baz] was found while it was expected to be missing.');
    ...
    public function testAssertWhereFailsWhenDoesNotMatchValue()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [bar] does not match the expected value.');
    ...
    public function testAssertWhereFailsWhenDoesNotMatchValueUsingClosure()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [bar] was marked as invalid using a closure.');
    ...
    public function testAssertWhereNullFailsWhenNotNull()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [bar] should be null.');
    ...
    public function testAssertWhereNotNullFailsWhenNull()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [bar] should not be null.');
    ...
    public function testAssertWhereContainsFailsWithEmptyValue()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [foo] does not contain [1].');
    ...
    public function testAssertWhereContainsFailsWithMissingValue()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [foo] does not contain [invalid].');
    ...
    public function testAssertWhereContainsFailsWithMissingNestedValue()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [id] does not contain [5].');
    ...
    public function testAssertWhereContainsFailsWhenDoesNotSatisfyClosure()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [foo] does not contain a value that passes the truth test within the given closure.');
    ...
    public function testAssertWhereContainsFailsWhenSatisfiesClosureButDoesNotHaveExpectedValue()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [foo] does not contain [5].');
    ...
    public function testAssertWhereContainsFailsUsingBackedEnum()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [bar] does not contain [test].');
    ...
    public function testAssertNestedWhereFailsWhenDoesNotMatchValue()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [example.nested] does not match the expected value.');
    ...
    public function testAssertWhereNotFailsWhenMatchingValue()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [bar] contains a value that should be missing: [bar, value]');
    ...
    public function testAssertWhereNotFailsUsingBackedEnum()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [bar] contains a value that should be missing: [bar, test]');
    ...
    public function testScopeFailsWhenPropSingleValue()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [bar] is not scopeable.');
    ...
    public function testFirstScopeFailsWhenNoProps()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Cannot scope directly onto the first element of the root level because it is empty.');
    ...
    public function testFirstNestedScopeFailsWhenNoProps()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Cannot scope directly onto the first element of property [foo] because it is empty.');
    ...
    public function testFirstScopeFailsWhenPropSingleValue()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [foo] is not scopeable.');
    ...
    public function testEachScopeFailsWhenNoProps()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Cannot scope directly onto each element of the root level because it is empty.');
    ...
    public function testEachNestedScopeFailsWhenNoProps()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Cannot scope directly onto each element of property [foo] because it is empty.');
    ...
    public function testFailsWhenNotInteractingWithAllPropsInScope()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Unexpected properties were found in scope [bar].');
    ...
    public function testCannotDisableInteractionCheckForDifferentScopes()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Unexpected properties were found in scope [bar.baz].');
    ...
    public function testTopLevelInteractionEnabledWhenInteractedFlagSet()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Unexpected properties were found on the root level.');
    ...
    public function testAssertWhereAllFailsWhenAtLeastOnePropDoesNotMatchValue()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [baz] was marked as invalid using a closure.');
    ...
    public function testAssertWhereTypeWhenWrongTypeIsGiven()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [foo] is not of expected type [integer].');
    ...
    public function testAssertWhereTypeWhenWrongUnionTypeIsGiven()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [foo] is not of expected type [string|null].');
    ...
    public function testAssertWhereTypeWithPipeInWrongUnionType()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [foo] is not of expected type [integer|null].');
    ...
    public function testAssertHasAllFailsWhenAtLeastOnePropMissing()
    {
        ...
        $this->expectException(AssertionFailedError::class);
        $this->expectExceptionMessageIsOrContains('Property [foo.baz] does not exist.');
    ...
    public function testMacroable()
    {
        ...
        $this->expectExceptionMessageIsOrContains('My Custom Macro was called!');
