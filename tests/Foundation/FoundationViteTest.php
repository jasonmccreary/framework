...
class FoundationViteTest extends TestCase
{
    ...
    public function testItThrowsWhenUnableToFindAssetManifestInBuildMode()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Vite manifest not found at: '.public_path('build/manifest.json'));
    ...
    public function testItThrowsWhenUnableToFindAssetChunkInBuildMode()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('Unable to locate file in Vite manifest: resources/js/missing.js');
    ...
    public function testItThrowsWhenUnableToFindFileToRetrieveContent()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('Unable to locate file from Vite manifest: '.public_path('build/assets/app.versioned.js'));
