...
class FoundationViteFontsTest extends TestCase
{
    ...
    public function testUnsupportedManifestVersionThrowsException()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('Unsupported font manifest version [99]. Supported versions: 1.');
    ...
    public function testMissingManifestVersionThrowsException()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('missing the [version] key');
    ...
    public function testMissingFamiliesKeyThrowsException()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('missing the [families] key');
    ...
    public function testMissingCssFileThrowsException()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('Unable to locate font CSS file');
    ...
    public function testUnknownRequestedAliasThrowsException()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('Font alias [display] is not defined in the font manifest. Available aliases: sans.');
    ...
    public function testMalformedPreloadEntryMissingAliasThrowsException()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('preload entry [0] is missing the [alias] key');
    ...
    public function testMalformedPreloadEntryMissingFileInBuildModeThrowsException()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('preload entry [0] for alias [sans] is missing the [file] key');
    ...
    public function testMalformedPreloadEntryMissingUrlInHotModeThrowsException()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('preload entry [0] for alias [sans] is missing the [url] key');
    ...
    public function testFontsThrowsContractExceptionWhenStyleVariablesIsAString()
    {
        ...
        $this->expectException(ViteException::class);
        $this->expectExceptionMessageIsOrContains('keyed by alias');
