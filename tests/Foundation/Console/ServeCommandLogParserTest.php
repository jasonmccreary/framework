...
class ServeCommandLogParserTest extends TestCase
{
    ...
    public function testExtractRequestPortWithMissingPort()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Failed to extract the request port. Ensure the log line contains a valid port: [Mon Nov 19 10:30:45 2024] Info');
    ...
    public function testExtractRequestPortWithInvalidPortFormat()
    {
        ...
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Failed to extract the request port. Ensure the log line contains a valid port: [Mon Nov 19 10:30:45 2024] :abcd Info');
    ...
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Failed to extract the request port. Ensure the log line contains a valid port: ');
    ...
    public function testExtractRequestPortWithRandomString()
    {
        ...
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessageIsOrContains('Failed to extract the request port. Ensure the log line contains a valid port: Random log entry without port');
