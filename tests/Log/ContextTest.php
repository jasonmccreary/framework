...
class ContextTest extends TestCase
{
    ...
    public function test_throws_when_pushing_to_non_array()
    {
        ...
        $this->expectExceptionMessageIsOrContains('Unable to push value onto context stack for key [breadcrumbs].');
        Context::push('breadcrumbs', 'bar');
    }
    ...
    public function test_throws_when_popping_from_empty_list()
    {
        ...
        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessageIsOrContains('Unable to pop value from context stack for key [breadcrumbs].');
    ...
    public function test_throws_when_popping_from_empty_hidden_list()
    {
        ...
        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessageIsOrContains('Unable to pop value from hidden context stack for key [breadcrumbs].');
    ...
    public function test_it_can_add_hidden()
    {
        ...
        $this->expectException(RuntimeException::class);
        $this->expectExceptionMessageIsOrContains('Unable to push value onto hidden context stack for key [foo].');
        Context::pushHidden('foo', 2);
    }
